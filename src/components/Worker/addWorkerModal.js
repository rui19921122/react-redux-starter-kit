...
let AddWorkerForm = React.createClass({
  handleSubmit(e) {
    e.preventDefault();
...
AddWorkerForm = Form.create()(AddWorkerForm);
  ...
  render() {
    return (
      <Modal title="增加员工"
        ...
        <AddWorkerForm position={this.props.worker.position} dispatch={this.props.dispatch}/>
      </Modal>
    )
  }
}
