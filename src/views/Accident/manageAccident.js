...
class manageStudy extends React.Component {
	...
	handleClick() {
		this.props.dispatch(actions.begin_update_study())
	}
					...
					<Col span="20">
						...
						<Row type="flex" justify="end">
							<Col span="4" pull="3" className="head-justify-not-first">
								<Button onClick={this.handleClick.bind(this)}>增加业务学习</Button>
							</Col></Row>
						<Row type="flex" justify="center">
							<Col span="15">
								<ListProfessionStudyTable study={this.props.study} dispatch={this.props.dispatch}/>
							</Col></Row>
					</Col>
				</Row>
